...
// Fetch requests that are both approved and completed
$user_id = $_SESSION['user_id']; // Assuming User ID is stored in session
$query = $conn->prepare("SELECT * FROM maintenance_requests WHERE user_id = ? AND status = 'approved' AND maintenance_status = 'completed'");
